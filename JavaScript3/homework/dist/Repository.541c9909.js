...
function () {
  ...
  _createClass(Repository, [{
    ...
    key: "createListE",
    value: function createListE(data, element) {
      var divContentE = document.querySelector('.content');
      var sectionE = Util.createAndAppend('section', divContentE, {
        id: data.name
      });
      var h2E = Util.createAndAppend('h2', sectionE, {
        text: 'MODULE ',
        class: 'h2'
      });
      ...
      var divE = Util.createAndAppend('div', sectionE, {
        id: 'repoInfo'
      });
      var moduleDetail = Util.createAndAppend('div', divE, {
        class: 'moduleDetail'
      });
...
},{}]},{},["../../../../../.npm/_npx/1200/lib/node_modules/parcel/src/builtins/hmr-runtime.js","Repository.js"], null)
//# sourceMappingURL=/Repository.541c9909.js.map