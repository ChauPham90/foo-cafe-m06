...
SELECT name, MAX(surfacearea) FROM country GROUP BY name ORDER BY MAX(surfacearea)DESC  LIMIT 1,10;
SELECT name, MAX(population) FROM city GROUP BY name ORDER BY MAX(population)DESC  LIMIT 1,10;
